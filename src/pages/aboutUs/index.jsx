...
const AboutUs = () => {
	...
	const MemberCard = ({ name, image, description, title, flip }) => {
		return (
			<div
				...
				dir={flip ? "rtl" : "ltr"}
			>
				<div className=' grid grid-cols-2 place-items-center rounded-md bg-membersLinesBg bg-no-repeat bg-center'>
					<img
						src={image}
						alt=''
					...
					<div dir='ltr' className='p-12 text-white max-md:col-span-2 '>
						...
						<p className='py-2 text-tiny font-light'>{description} </p>
					</div>
				</div>
			</div>
		);
	...
	return (
		<div>
			...
			<br />
			<br />
			<div className='px-[5%] py-16 space-y-28'>
