		...
		<div id='register' className='w-[75vw] max-w-[700px] my-12'>
			<form className='flex flex-col justify-between items-stretch h-full w-full space-y-4'>
				...
				<PhoneInput
					...
					dropdownClass='!bg-primary/70 !backdrop-blur-[21px] !text-third '
				...
				<button
					className={`bg-secondary text-primary font-semibold text-smaller md:text-small w-full py-2  disabled:bg-none disabled:bg-gray-500 disabled:text-white rounded-md ${
